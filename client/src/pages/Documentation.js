    ...
    return(
        <div className='wrapper'>
            ...
            <p>To use this React App, all you need to do is fill out the forms, and click the add button below!. Some are optional, such as the fieldsets that have a 
                add button right next to the fields, so don't worry about filling those out unless you want to. Other forms only allow you to add only one of them, like the 
                Personal Information. All fields also have a function to individually delete 
